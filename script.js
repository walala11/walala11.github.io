const slides = [
  ...
  },
  {
    kicker: "18 / 引用与边界",
    title: "资料从哪里来，我们如何理解",
    body: "本作品将图像修复与历史叙事分开说明：原始图像负责提供可核对的视觉依据，修复图只帮助辨认；正文则建立在公共可查资料之上，经交叉核对后重新组织，并在史实基础上形成小组的总结与思考。",
    visual: `
      <div class="source-grid source-grid-two">
        <article>
          <b>01　黑白原图与修复说明</b>
          <span>核心对比使用项目素材中的中共一大会址黑白图（site-bw.jpg）和南湖画舫黑白图（boat-bw.jpg），历史对象参照中共一大纪念馆、南湖革命纪念馆公开展陈资料。其余四组为本组制作的修复演示底图，不作为原始史料。所有上色、清晰化结果仅用于辅助辨认，不等同于真实彩色照片。</span>
        </article>
        <article>
          <b>02　正文来源、总结与思考</b>
          <span>正文综合共产党员网“中国共产党第一次全国代表大会”专题、新华网“弘扬红船精神”相关报道、中国政府网及上海市政府公开资料，围绕一大从上海召开到嘉兴南湖完成的过程重新梳理。我们认为，数字化表达的价值不在替历史“增色”，而在让地点、事件与精神之间的关系更清楚；技术可以拉近观看距离，但史实判断仍须回到可核验资料。</span>
        </article>
      </div>`
  },
  {
